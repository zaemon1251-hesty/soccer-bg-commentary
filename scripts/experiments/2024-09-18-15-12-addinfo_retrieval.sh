...
INPUT_FILE="outputs/$TARGET_GAME/2024-09-17-12-24-results_spotting_query.jsonl"
OUTPUT_FILE="outputs/$TARGET_GAME/2024-09-18-12-24-results_addinfo_retrieval.jsonl"
